...
export const meta = {
  id: 'org-level-billing',
  title: 'Organization-Level-Billing',
  description: 'Learn about the new Organization-Level-Billing',
}

<Admonition type="note">
  Org-Level-Billing was introduced on September 4th 2023. Read the [announcement](https://announce.ment) for more context.
</Admonition>
...
**New Organization-Level-Billing**
...
## Comparing Legacy vs. Organization-Level-Billing

<Admonition type="note">
  If you are using Legacy Billing and have a single project in you're organization, there is no change in pricing or quota.
</Admonition>

Here are some examples on how the new Organization-Level-Billing looks like compared to the legacy project-level billing.

### Single free plan project

If you’re just running a single free project, migrating to org-level-billing comes with no disadvantage and big benefit: you now get a lot more egress.
...
**Invoice Breakdown with Organization-Level-Billing**
