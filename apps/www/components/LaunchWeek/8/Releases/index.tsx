              ...
              {preRelease.steps.length > 0 && (
                <div className="h-[400px] flex flex-col gap-5 lg:flex-row pb-4">
                  ...
                  >
                    ...
                    />
                    <div className="flex flex-col items-center lg:items-start gap-2 max-w-[450px] w-full text-center lg:text-left">
                      <CartTitle>
                        Coding the stars: building an interactive constellation with Three.js and
                        React Three Fiber
                      </CartTitle>
