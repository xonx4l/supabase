...
Most customers will pay less because we are offering more egress for free. We’re very conscious about the current users and use-cases. For a more detailed breakdown and some examples, head over to the docs. If you are concerned that your bill has increased as a result of this change please reach out [here](https://supabase.com/dashboard/support/new?category=billing&subject=Organization%20based%20billing).
